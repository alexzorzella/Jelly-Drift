...
public class BuildVersionProcessor : IPreprocessBuildWithReport {
  const string defaultVersion = "24.11.9";
  ...
  /// the `currentVersion` and the current date it is right `now`.
  /// 
  ...
  /// <param name="truncatedSha"></param>
  /// <param name="isGitClean"></param>
  /// <returns></returns>
  static String NewVersion(
    ...
    var lastVersionMatch = versionExtractorRegexp.Match(lastVersion);
